...
- `claimedBy` (qué dispositivo controla cada equipo) solo lo puede fijar quien lo reclamó primero con el PIN — nadie puede "robar" el asiento de otro equipo, ni desde la consola del navegador.
